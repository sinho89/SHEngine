...
#include <com/amazonaws/kinesis/video/signaling/Signaling.h>
#include <atomic>
...
typedef struct {
    ...
    engine_ptr<class ixrAWSKinesisVideoWebRTCComponent> AWSKinesisVideoWebRTCComponent;
...
STATUS createSampleConfiguration(PCHAR, PCHAR, SIGNALING_CHANNEL_ROLE_TYPE, BOOL, BOOL, PSampleConfiguration*);
...
STATUS CheckSessionCleanup(PSampleConfiguration);
